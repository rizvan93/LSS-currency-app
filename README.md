...
*Wireframes of various pages in the app*
...
*Snippet of routings with REST conventions for Trainee model.*
```Javascript
...
router.get("/:traineeId/edit", isAuth(["admin", "traineeAdmin"]), isTrainee, traineeCtrl.edit);
router.put("/:traineeId", isAuth(["admin", "traineeAdmin"]), isTrainee, traineeCtrl.update);
...
*Snippet of function to update currency requirements after attending a training*
```Javascript
...
*Snippet of currency requirements stored in separate file (one shown)*
```Javascript
